...
Write-Host ""
Write-Host "Starting backend on http://localhost:9400  (Ctrl+C to stop)" -ForegroundColor Green
Start-Process "http://localhost:9400/rca_console.html"
Set-Location "$root\backend"
python -m uvicorn sql_backend:app --host 0.0.0.0 --port 9400
